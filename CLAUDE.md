...
- **Ecosystem app policies** are defined in each repo's `enclii.yaml` `network:` section and generated by the control plane's netpolicy generator (`apps/switchyard-api/internal/netpolicy/generator.go`)
